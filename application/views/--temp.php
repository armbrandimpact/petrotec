...
<div style="padding:10px 180px; width:100%">
					...
					<div class="an-bootstrap-custom-tab">
						<div class="an-tab-control">
							...
							<ul class="nav nav-tabs text-left" role="tablist">
								...
								<li role="presentation">
									<a href="#" title="Payment selected in this as default for this customer"><i class="glyphicon glyphicon-question-sign"></i></a>
								</li>
							</ul>
						</div>
						<!-- Tab panes -->
	...
	<div class="row">
		...
		<div class="col-md-6">
			<a href="#" class="btn btn-primary btn-block"data-toggle="modal" data-target="#myModalone">Add Customer</a>
